...
public class ChefOnIngredientUpdateTest extends TestHarness {
	...
	@ParameterizedTest
	@CsvFileSource(resources = "/chef/ingredient/update-negative.csv", encoding = "utf-8", numLinesToSkip = 1)
	@Order(10)
	public void negativeTest(final int recordIndex, final String name, final String code, final String description, final String retailPrice, final String link) {
		super.signIn("chef1", "chef1");
