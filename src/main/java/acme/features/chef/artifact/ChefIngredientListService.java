...
@Service
public class ChefIngredientListService implements AbstractListService<Chef, Artifact> {
	...
	public Collection<Artifact> findMany(final Request<Artifact> request) {
		...
		result = this.repository.findManyByArtifactTypeAndChef(ArtifactType.INGREDIENT, principal.getActiveRoleId());
