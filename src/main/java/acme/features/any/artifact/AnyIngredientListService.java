...
@Service
public class AnyIngredientListService implements AbstractListService<Any, Artifact> {
	...
	public Collection<Artifact> findMany(final Request<Artifact> request) {
		...
		result = this.repository.findManyByArtifactTypeAndPublised(ArtifactType.INGREDIENT);
